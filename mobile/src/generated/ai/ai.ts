...
export const TrainingPlan: MessageFns<TrainingPlan> = {
  encode(message: TrainingPlan, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.sessions) {
      TrainingSession.encode(v!, writer.uint32(58).fork()).join();
    }
...
export const TrainingSession: MessageFns<TrainingSession> = {
  encode(message: TrainingSession, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.exercises) {
      ExercisePlan.encode(v!, writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TrainingSession {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExercisePlan: MessageFns<ExercisePlan> = {
  encode(message: ExercisePlan, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExercisePlan {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RecommendationResponse: MessageFns<RecommendationResponse> = {
  encode(message: RecommendationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.recommendations) {
      ExerciseRecommendation.encode(v!, writer.uint32(18).fork()).join();
    }
    if (message.generatedAt !== "") {
...
export const ExerciseRecommendation: MessageFns<ExerciseRecommendation> = {
  encode(message: ExerciseRecommendation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.exerciseName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExerciseRecommendation {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProgressAnalysisRequest: MessageFns<ProgressAnalysisRequest> = {
  encode(message: ProgressAnalysisRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    if (message.trainingId !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProgressAnalysisRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProgressAnalysisResponse: MessageFns<ProgressAnalysisResponse> = {
  encode(message: ProgressAnalysisResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    ...
    for (const v of message.strengthAreas) {
      StrengthAreaAnalysis.encode(v!, writer.uint32(26).fork()).join();
    }
    for (const v of message.weaknessAreas) {
      WeaknessAreaAnalysis.encode(v!, writer.uint32(34).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProgressAnalysisResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const StrengthAreaAnalysis: MessageFns<StrengthAreaAnalysis> = {
  encode(message: StrengthAreaAnalysis, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.area !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StrengthAreaAnalysis {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WeaknessAreaAnalysis: MessageFns<WeaknessAreaAnalysis> = {
  encode(message: WeaknessAreaAnalysis, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.area !== "") {
      writer.uint32(10).string(message.area);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WeaknessAreaAnalysis {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export class AIServiceClientImpl implements AIService {
  ...
  AnalyzeProgress(request: ProgressAnalysisRequest): Promise<ProgressAnalysisResponse> {
    ...
    return promise.then((data) => ProgressAnalysisResponse.decode(new BinaryReader(data)));
  }

  GenerateTrainingPlan(request: UserProfile): Promise<TrainingPlan> {
    const data = UserProfile.encode(request).finish();
    const promise = this.rpc.request(this.service, "GenerateTrainingPlan", data);
    return promise.then((data) => TrainingPlan.decode(new BinaryReader(data)));
  }
}
