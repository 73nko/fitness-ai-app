...
export const RegisterRequest: MessageFns<RegisterRequest> = {
  encode(message: RegisterRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.profileData !== undefined) {
      ProfileData.encode(message.profileData, writer.uint32(42).fork()).join();
    }
    return writer;
  },
...
export const UpdateProfileRequest: MessageFns<UpdateProfileRequest> = {
  encode(message: UpdateProfileRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.profileData !== undefined) {
      ProfileData.encode(message.profileData, writer.uint32(18).fork()).join();
    }
    return writer;
  },
...
export const UserResponse: MessageFns<UserResponse> = {
  encode(message: UserResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.profile !== undefined) {
      ProfileData.encode(message.profile, writer.uint32(42).fork()).join();
    }
    return writer;
  },
...
export const ProfileResponse: MessageFns<ProfileResponse> = {
  encode(message: ProfileResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.profile !== undefined) {
      ProfileData.encode(message.profile, writer.uint32(18).fork()).join();
    }
    return writer;
  },
